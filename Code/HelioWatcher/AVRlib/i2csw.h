...
void i2cSendA(BYTE_AVRLIB device, BYTE_AVRLIB sub, BYTE_AVRLIB length, BYTE_AVRLIB *data);
void i2cSendB(BYTE_AVRLIB device, BYTE_AVRLIB sub, BYTE_AVRLIB length, BYTE_AVRLIB *data);

// receive I2C data from <device> register <sub>
void i2cReceiveA(BYTE_AVRLIB device, BYTE_AVRLIB sub, BYTE_AVRLIB length, BYTE_AVRLIB *data);
void i2cReceiveB(BYTE_AVRLIB device, BYTE_AVRLIB sub, BYTE_AVRLIB length, BYTE_AVRLIB *data);
